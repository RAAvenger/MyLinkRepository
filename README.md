...
- [Will AI Replace Junior Software Developers?](https://www.youtube.com/watch?v=AK9pFlLJwbQ): In my mind using ai to write code is to good to be true and i have seen many mistakes from especially inexperienced developers when they write code with ai. In this video the usage of ai to write code is studied and differences of it when an experienced developer uses it and when an inexperienced one use it is explained. 
